(async () => {
  ...
  const _0x3bc568 = (_0x5317ce) =>
    new Promise((_0x55cf2f) => _0x47ba5e.question(_0x5317ce, _0x55cf2f));
  global.API = (_0x453b31, _0x5ea4d0 = "/", _0x1d2fe3 = {}, _0x1bc09b) =>
    (_0x453b31 in global.APIs ? global.APIs[_0x453b31] : _0x453b31) +
    _0x5ea4d0 +
    (_0x1d2fe3 || _0x1bc09b
      ? "?" +
        new URLSearchParams(
  ...
  global.opts = new Object(
    _0x276499(process.argv.slice(0x2)).exitProcess(false).parse()
  );
  ...
  global.db = new _0x133260(
    /https?:\/\//.test(opts.db || "")
      ...
      : new _0x2627b5((opts._[0x0] ? opts._[0x0] + "_" : "") + "database.json")
  );
  ...
  const { version: _0x5a53bc, isLatest: _0x59dded } = await _0x1785e0();
  console.log(
    _0x88dc80.magenta(
      "-- using WA v" + _0x5a53bc.join(".") + ", isLatest: " + _0x59dded + " --"
    )
  );
  const _0x12181b = {
    ...
    patchMessageBeforeSending: (_0x5826df) => {
      const _0x328020 = !!(
        _0x5826df.buttonsMessage ||
        _0x5826df.templateMessage ||
        _0x5826df.listMessage
      );
      if (_0x328020) {
        _0x5826df = {
          viewOnceMessage: {
    ...
    if (global.db) {
      setInterval(async () => {
        ...
        if (!opts.tmp && (global.support || {}).find) {
          ...
          tmp.forEach((_0x400962) =>
            _0xc1204a.spawn("find", [
              _0x400962,
              "-amin",
              "3",
              "-type",
  ...
  async function _0x478e67(_0x219e74) {
    const { connection: _0x4b1c77, lastDisconnect: _0x514321 } = _0x219e74;
    global.timestamp.connect = new Date();
    if (
      _0x514321 &&
      _0x514321.error &&
      _0x514321.error.output &&
      _0x514321.error.output.statusCode !== _0x53ced4.loggedOut &&
      conn.ws.readyState !== _0x524852.CONNECTING
    ) {
  ...
  if (
    (_0x2ab022 || _0x4c1105) &&
    _0x32f29f.existsSync("./sessions/creds.json") &&
  ...
  if (_0x2ab022 && !conn.authState.creds.registered) {
    ...
    console.log(
      _0x88dc80.bgWhite(_0x88dc80.blue("-- Please wait, generating code... --"))
    );
    setTimeout(async () => {
      let _0x1198cf = await conn.requestPairingCode(_0x25d10d);
      _0x1198cf = _0x1198cf?.["match"](/.{1,4}/g)?.["join"]("-") || _0x1198cf;
      console.log(
        _0x88dc80.black(_0x88dc80.bgGreen("Your Pairing Code : ")),
        _0x88dc80.black(_0x88dc80.white(_0x1198cf))
      );
    }, 0xbb8);
  }
  ...
  const _0x28dbc1 = (_0x30060a) => {
    ...
    do {
      ...
      (!_0x5db7b4 || Array.isArray(_0x5db7b4) || _0x5db7b4 instanceof String
        ? !(_0x5db7b4 || []).length
        : typeof _0x5db7b4 == "object" && !Buffer.isBuffer(_0x5db7b4)
        ? !Object.keys(_0x5db7b4 || {}).length
        : true) &&
      _0x2a1668 <= 0xa
    );
    return _0x5db7b4;
  ...
  global.reload = (_0x3113db, _0x35b4ad) => {
    if (/\.js$/.test(_0x35b4ad)) {
      ...
      if (_0x411a74) {
        conn.logger.error(
          "syntax error while loading '" + _0x35b4ad + "'\n" + _0x411a74
        );
      } else {
        try {
          ...
          global.plugins = Object.fromEntries(
            Object.entries(global.plugins).sort(([_0x510347], [_0x59a90c]) =>
              _0x510347.localeCompare(_0x59a90c)
            )
          );
        }
      }
  ...
  async function _0x5adff5() {
    let _0x547272 = await Promise.all(
      [
        _0xc1204a.spawn("ffmpeg"),
        _0xc1204a.spawn("ffprobe"),
        _0xc1204a.spawn("ffmpeg", [
          "-hide_banner",
          "-loglevel",
          "error",
        ...
        _0xc1204a.spawn("convert"),
        _0xc1204a.spawn("magick"),
        _0xc1204a.spawn("gm"),
        _0xc1204a.spawn("find", ["--version"]),
      ].map((_0x568faa) => {
        return Promise.race([
