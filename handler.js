            ...
            for (let name in global.plugins) {
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                        this.reply(m.chat, `Limit anda habis, silahkan beli melalui *${usedPrefix}buy* atau beli di *${usedPrefix}shop*, Ingin Limit Unlimited? Beli Premium di *${usedPrefix}prem*.`, m)
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        premium: 'Perintah ini hanya untuk member _*Premium*_ !, Silahkan Beli Di (.premium)',
